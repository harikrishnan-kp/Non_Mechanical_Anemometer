...
The [code](https://github.com/shruthigirija/Non_Mechanical_Anemometer/blob/cb949cbcc00fb8e3de17bd560c8b5f9c65920337/Software/Arduino/Final_code_for_ultrasonic_anemometer.ino) uploaded to the arduino nano ble 33 sense board.
FWind Data is available at serial port of the connected terminal as shown in [Fig](https://github.com/shruthigirija/Non_Mechanical_Anemometer/blob/cb949cbcc00fb8e3de17bd560c8b5f9c65920337/Images/anemometer_output_arduino.png), in the following format, Data Format is Date, T N-S, T S-N, T E-W , T W-E, Wind Speed, Wind Direction respectively.After the calculation, found the wind velocity and the [result](https://github.com/shruthigirija/Non_Mechanical_Anemometer/blob/cb949cbcc00fb8e3de17bd560c8b5f9c65920337/Images/cup%20vs%20ultrasonic%20anemometr.png) attached here. In the experiment, cup, digital, and ultrasonic anemometers with different sampling rates are used to measure wind velocity, with raw data containing a 7 m/s shift. Cup anemometer data, sampled at 120 samples per minute, is downsampled to 15 samples per minute to match the ultrasonic anemometer data for comparison. By taking elapsed time as the reference, averaging the downsampled data, and analyzing it with moving averages, we achieve  72.62% accuracy and 27.38% error rate.
